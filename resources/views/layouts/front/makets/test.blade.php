        ...
        <header id="masthead" class="header ttm-header-style-01">
            ...
            <div class="fbar-main">
                <div class="fbar-main-inner">
                    <div class="fbar-btn"><a href="index.html#"><i class="ti ti-menu"></i></a></div>
                    <!-- fbar-contents -->
                            ...
                            <div class="top_bar_contact_item">
                                <div class="top_bar_social">
                                    <ul class="social-icons">
                                        <li><a class="tooltip-bottom" target="_blank" href="index.html" data-tooltip="Facebook" tabindex="-1"><i class="fa fa-facebook"></i></a>
                                        </li>
                                        <li><a class="tooltip-bottom" target="_blank" href="index.html" data-tooltip="Twitter" tabindex="-1"><i class="fa fa-twitter"></i></a>
                                        </li>
                                        <li><a class="tooltip-bottom" target="_blank" href="index.html" data-tooltip="Flickr" tabindex="-1"><i class="fa fa-flickr"></i></a>
                                        </li>
                                        <li><a class="tooltip-bottom" target="_blank" href="index.html" data-tooltip="Linkedin" tabindex="-1"><i class="fa fa-linkedin"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="index.html#">Request a Info</a>
                        </div>
                    </div>
                </div>
            </div><!-- top_bar end-->
                                ...
                                <div class="site-navigation d-flex flex-row">
                                        ...
                                        <ul class="menu">
                                            <li class="mega-menu-item active">
                                                ...
                                                <ul class="mega-submenu">
                                                    <li class="active"><a href="index.html">Home School</a></li>
                                                    <li><a href="home-2.html">Home University</a></li>
                                                    <li><a href="home-3.html">Home Institute</a></li>
                                                    <li><a href="home-4.html">Home College</a></li>
                                                    <li><a href="home-shop.html">Home Shop</a></li>
                                                    <li class="mega-menu-item">
                                                        <a href="index.html#" class="mega-menu-link">Header Styles</a>
                                                        <ul class="mega-submenu">
                                            ...
                                            <li class="mega-menu-item megamenu-fw">
                                                <a href="index.html#" class="mega-menu-link">Pages</a>
                                            ...
                                            <li class="mega-menu-item">
                                                <a href="index.html#" class="mega-menu-link">Courses</a>
                                                <ul class="mega-submenu">
                                            ...
                                            <li class="mega-menu-item">
                                                <a href="index.html#" class="mega-menu-link">Blog</a>
                                                <ul class="mega-submenu">
                                            ...
                                            <li class="mega-menu-item">
                                                <a href="index.html#" class="mega-menu-link">Contact Us</a>
                                                <ul class="mega-submenu">
                                    ...
                                    <div class="header_extra d-flex flex-row align-items-center justify-content-end">
                                        <div class="header_search">
                                            <a href="index.html#" class="btn-default search_btn"><i class="ti ti-search"></i></a>
                                            <div class="header_search_content">
                                                <form id="searchbox" method="get" action="index.html#">
                                        ...
                                        <div class="header_cart">
                                            <a href="index.html#" class="button-cart">
        ...
        <div class="banner-slider-wrapper">
            <div class="banner-slider slick_slider slick-arrows-style1" data-slick='{"slidesToShow": 1, "slidesToScroll": 1, "arrows":true, "autoplay":true, "centerMode":true, "centerPadding":0, "infinite":true, "initialSlide":2, "responsive": [{"breakpoint":870,"settings":{"slidesToShow": 1}} , {"breakpoint":525,"settings":{"slidesToShow": 1}}]}'>
                ...
                <div class="banner-slide">
                    <img class="img-fluid lazyload" data-src="https://acadevo.themetechmount.net/wp-content/uploads/2019/09/mainslider-bg-001.jpg" alt="slider-image"/>
                    <div class="banner-caption">
                        <div class="info">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="banner-text ttm-textcolor-white">
                                            <div class="ttm-icon ttm-icon_element-onlytxt ttm-icon_element-color-white ttm-icon_element-size-md mb-10 animated fadeIn delay-1s">
                                                <i class="flaticon-school-3"></i>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="left slideInLeft animated slower">
                                                    <h5>Alumni</h5>
                                                    <h5>Association</h5>
                                                </div>
                                                <div class="right slideInRight animated border-left pl-15 ml-15">
                                                    <h6>OUR<br>NATIONAL<br>UNIVERSITY </h6>
                                                </div>
                                            </div>
                                            <div class="mt-15 mb-30">
                                                <h2 class="slideInLeft animated slower">Working Diligently </h2>
                                                <h2 class="slideInLeft animated slower delay-1s">for the Benifit of </h2>
                                                <h2 class="slideInLeft animated slower delay-2s">all Alumni. </h2>
                                            </div>
                                            <div class="fadeInUp animated delay-4s">
                                                <a href="index.html#" class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-btn-color-white">Join Us Now!</a>
                                            </div>
                                        </div>
                                        <div class="d-flex fadeIn animated slower delay-3s">
                ...
                <div class="banner-slide">
                    <img class="img-fluid lazyload" data-src="https://acadevo.themetechmount.net/wp-content/uploads/2019/09/mainslider-bg-002.jpg" alt="slider-image"/>
                    <div class="banner-caption">
                        <div class="info">
                            <div class="container">
                                <div class="d-lg-flex justify-content-end">
                                    <div class="mt-40 res-991-mt-0">
                                        ...
                                        <div class="fadeInUp animated delay-3s mt-15">
                                            <a href="index.html#" class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-btn-color-white mr-3">Learn more</a>
                                            <span class="ttm-bgcolor-darkgrey">
                                                <a href="index.html#" class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor">Get it now</a>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex fadeIn animated slower delay-3s">
                                    <div class="featured-icon-box icon-align-before-content mt-40 mr-auto">
                                        <div class="featured-icon">
                                            <div class="ttm-icon ttm-icon_element-fill ttm-icon_element-style-square ttm-icon_element-color-skincolor ttm-icon_element-size-sm">
                                                <i class="fa fa-play pl-5"></i>
                                            </div>
                                        </div>
                                        <div class="featured-content">
                                            <div class="featured-title">
    ...
    <div class="site-main">
        ...
        <section class="ttm-row features-section clearfix">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mt_60 res-991-mt-15 ttm-bgcolor-white box-shadow">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="featured-icon-box icon-align-top-content text-center style1">
                                        ...
                                        <div class="featured-content">
                                            ...
                                            <a class="ttm-btn btn-inline ttm-btn-size-md ttm-icon-btn-right ttm-btn-color-skincolor" href="index.html" title="">Read more<i class="fa fa-chevron-right"></i></a>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="featured-icon-box icon-align-top-content text-center style1">
                                        ...
                                        <div class="featured-content">
                                            ...
                                            <div class="featured-desc">
                                                <p>There are many variations of passages Lorem Ipsum available, but the majority.</p>
                                            </div>
                                            <a class="ttm-btn btn-inline ttm-btn-size-md ttm-icon-btn-right ttm-btn-color-skincolor" href="index.html" title="">Read more<i class="fa fa-chevron-right"></i></a>
                                        </div>
                                    </div><!-- featured-imagebox end-->
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="featured-icon-box icon-align-top-content text-center style1">
                                        ...
                                        <div class="featured-content">
                                            ...
                                            <div class="featured-desc">
                                                <p>Lorem Ipsum is simply dummy text type setting industry. Loremsum industry.</p>
                                            </div>
                                            <a class="ttm-btn btn-inline ttm-btn-size-md ttm-icon-btn-right ttm-btn-color-skincolor" href="index.html" title="">Read more<i class="fa fa-chevron-right"></i></a>
                                        </div>
                                    </div><!-- featured-imagebox end-->
                    ...
                    <div class="col-lg-5 col-md-7 col-sm-9 mt-0 mx-auto">
                        ...
                        <div class="border mr_60 res-991-mr-0">
                            <div class="ttm_single_image-wrapper pt-10 pl-10 pr-10 pb-10">
                                <img class="img-fluid lazyload" data-src="{{ asset('frontend/images/single-img-one.jpg')}}" alt="image">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="pt-10 pl-80 res-991-pl-0 res-991-pt-30">
                            ...
                            <div class="section-title">
                                <div class="title-header">
                                    <h5>ABOUT Uniaro</h5>
                                    <h2 class="title">Introduce Uniaro We Build Everything</h2>
                                </div>
                                    ...
                                    <div class="featured-icon-box icon-align-before-content style4">
                                        <div class="featured-icon">
                                            <div class="img-content">
                                                <img class="lazyload" data-src="{{ asset('frontend/images/author-sign.png')}}" alt="ttm_single_image-wrapper">
                                            </div>
                                        </div>
        ...
        <section class="ttm-row course-section ttm-bgcolor-grey clearfix">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mt-30 res-991-mt-15 mb_25 text-center"><p>Don’t hesitate, contact us for better help and services. <u><a href="index.html#"><strong>Explore all Courses.</strong></a></u></p></div>
                    </div>
                </div><!-- row end -->
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="pr-60 res-991-pr-0">
                            ...
                            <p>Creating an enduring a strategic plan for the university’s, one that is now in its third five-year cycle. By including training many sectors workings behind. I was able to gain campus-wide buy-in on a shared vision.</p>
                            ...
                            <div class="mt-60 pt-25 pb-5 pl-30 mr_90 res-991-mr-0 res-991-mb-15 ttm-bgcolor-skincolor">
                                <div class="row align-items-center">
                                    <div class="col-sm-10">
                                        <h4 class="mb-5 font-weight-normal">Get Unlimited Access To Premium Courses</h4>
                                        <p>Taking seamless key performance indicators offline to maximize<br>the long tail to determine their progression.</p>
                                    </div>
                                    <div class="col-sm-2">
                                        <a href="index.html#">
                    ...
                    <div class="col-lg-5">
                        ...
                        <img  class="ttm-equal-height-image img-fluid lazyload" data-src="{{ asset('frontend/images/bg-image/col-bgimage-1.jpg')}}" alt="bg-image">
                    </div>
                </div><!-- row end -->
            </div>
        </section>
        ...
        <section class="ttm-row event-section ttm-bgcolor-white mt_60 res-991-mt-0 clearfix">
            <div class="container">
                ...
                <!-- slick_slider -->
                <div class="slick_slider slick-arrows-style1" data-slick='{"slidesToShow": 1, "slidesToScroll": 3, "arrows":true, "dots":false, "autoplay":true, "centerMode":true, "centerPadding":"300px", "infinite":true, "responsive": [{"breakpoint":991,"settings":{"slidesToShow": 1, "centerPadding":"0px","centerMode":false }} ]}'>
                    <div class="ttm-box-col-wrapper col-lg-4">
                        ...
                        <div class="featured-imagebox featured-imagebox-event">
                            ...
                            <div class="featured-content featured-content-event">
                                ...
                                <div class="ttm-eventbox-footer">
                                     <a class="ttm-btn ttm-btn-size-sm ttm-btn-shape-square ttm-icon-btn-right ttm-btn-style-fill ttm-btn-color-skincolor" href="index.html#">View Details<i class="fa fa-angle-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="ttm-box-col-wrapper col-lg-4">
                        ...
                        <div class="featured-imagebox featured-imagebox-event">
                            <div class="ttm-post-thumbnail featured-thumbnail"> 
                                <img class="img-fluid lazyload" data-src="{{ asset('frontend/images/event/event-img-four.jpg')}}" alt="image"> 
                                <div class="ttm-box-event-date">
                                    <span class="ttm-entry-date">
                                        <time class="entry-date" datetime="2019-07-20T07:07:55+00:00">14<span class="entry-month">may</span></time>
                                    </span>
                                </div>
                            </div>
                            <div class="featured-content featured-content-event">
                                <div class="event-title featured-title">
                                    <h5><a href="courses-single.html">Certificate Course on International Tax</a></h5>
                                </div>
                                <div class="ttm-box-meta ttm-events-meta">
                                    <div class="ttm-meta-details ttm-event-meta-details">
                                        <div class="ttm-event-meta-item ttm-event-date"> 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mt-20 mb_25 text-center"><p>Don’t hesitate, contact us for better help and services. <u><a href="index.html#"><strong>View More Events.</strong></a></u></p></div>
                    </div>
                </div><!-- row end -->
            </div>
        </section>
                        ...
                        <div class="ttm-bg ttm-col-bgcolor-yes ttm-left-span ttm-bgcolor-skincolor spacing-1">
                            ...
                            <div class="layer-content">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h5>WHY Uniaro</h5>
                                        <h2 class="title">What Our<br>Happy Student Say</h2>
                                    </div>
                                    <div class="heading-seperator"><span></span></div>
                                </div><!-- section title end -->
                                <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It hasclassical Latin literature from Contrary</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                                            ...
                                            <div class="ttm-box-col-wrapper col-lg-12">
                                                ...
                                                <div class="testimonials ttm-testimonial-box-view-style1"> 
                                                    <div class="testimonial-content">
                                                        ...
                                                        <blockquote>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, soforby blinded by desire, that they cannot foresee the pain and trouble.<br />It has roots in a piece of lassical.</blockquote>
        ...
        <!--broken-section end-->
         ...
         <!--client-section-->
        <div class="ttm-row client-section ttm-bgcolor-grey mt_60 res-991-mt-0 clearfix">
            <div class="container">
                <!-- row -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-9 m-auto">
                        ...
                        <div class="section-title with-sep title-style-center_text">
                            <div class="title-header">
                                <h5>YOU CAN LEARN</h5>
                                <h2 class="title">Our Course Workflow</h2>
                            </div>
                            <div class="heading-seperator"><span></span></div>
                        </div><!-- section-title end -->
                    </div>
                ...
                <div class="row"><!-- row -->
                    <div class="col-lg-3">
                        ...
                        <div class="featured-imagebox featured-imagebox-procedure">
                            <div class="featured-thumbnail">
                                <img class="img-fluid lazyload" data-src="{{ asset('frontend/images/process-img-one-162x162.jpg')}}" alt="image">
                            ...
                            <div class="featured-content">
                                ...
                                <div class="featured-desc">
                                    <p>Discuss with our team members for possible activities take.</p>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="featured-imagebox featured-imagebox-procedure">
                            <div class="featured-thumbnail">
                                <img class="img-fluid lazyload" data-src="{{ asset('frontend/images/process-img-two-162x162.jpg')}}" alt="image">
                                <div class="process-num"></div>
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                                ...
                                <div class="featured-desc">
                                    <p>A complex task must be divided into sub-parts to perform.</p>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="featured-imagebox featured-imagebox-procedure">
                            <div class="featured-thumbnail">
                                <img class="img-fluid lazyload" data-src="{{ asset('frontend/images/process-img-three-162x162.jpg')}}" alt="image">
                                <div class="process-num"></div>
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                                ...
                                <div class="featured-desc">
                                    <p>A list of activities includes one or more specific task upon.</p>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="featured-imagebox featured-imagebox-procedure">
                            <div class="featured-thumbnail">
                                <img class="img-fluid lazyload" data-src="{{ asset('frontend/images/process-img-four-162x162.jpg')}}" alt="image">
                                <div class="process-num"></div>
                            </div>
                            <div class="featured-content">
                                <div class="featured-title">
                                ...
                                <div class="featured-desc">
                                    <p>The process of a combining ideas into object thought.</p>
                                </div>
                            </div>
                        </div><!-- featured-imagebox end-->
                    </div>
        ...
        <section class="ttm-row cta-section ttm-bgcolor-skincolor text-center clearfix">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="font-weight-normal">Inter Collage Art & Painting Competation <u><a href="index.html#">Conatct Us</a></u></h4>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 widget-area">
                        <div class="widget widget_text clearfix">
                            <div class="footer-logo">
                                <img id="footer-logo-img" class="img-center lazyload" data-src="{{ asset('frontend/images/footer-logo.png')}}" alt="image">
                            </div>
                        ...
                        <div class="widget widget_nav_menu clearfix">
                           <h3 class="widget-title">Usefull Links</h3>
                            <ul id="menu-footer-quick-links">
                                <li><a href="index.html#">Physics & Astronomy</a></li>
                                <li><a href="index.html#">General Engineering</a></li>
                                <li><a href="index.html#">Departments Services</a></li>
                                <li><a href="index.html#">Geography & Geology</a></li>
                                <li><a href="index.html#">Campus Directions</a></li>
                                <li><a href="index.html#">Academic Solutions</a></li>
                                <li><a href="index.html#">About Our College</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 widget-area">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 widget-area">
                        <div class="widget widget_nav_menu clearfix">
                           <h3 class="widget-title">Our Services</h3>
                            <ul id="menu-footer-services">
                                ...
                                <li><a href="index.html#">Kids Courses</a></li>
                        ...
                        <div class="widget widget-text clearfix">
                           <h3 class="widget-title">Newsletter</h3>
                            <form id="subscribe-form" method="post" action="index.html#" data-mailchimp="true">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul id="menu-footer-menu" class="footer-nav-menu ttm-textcolor-white">
                            ...
                            <li><a href="index.html#">Free Language Services</a></li>
                            <li><a href="index.html#">Terms Of Use</a></li>
                            <li><a href="index.html#">Contact</a></li>
                            <li><a href="index.html#">Webmaster Login</a></li>
                        </ul>
                        <div class="d-sm-flex flex-row align-items-center justify-content-center pt-35 pb-15">
                            <img data-src="{{ asset('frontend/images/footer-award-one.png')}}" class="img-fluid lazyload" alt="award-one">
                            <div class="ml-30 pl-30 border-left res-575-ml-0 res-575-pl-0 res-575-mt-20">
                                <img data-src="{{ asset('frontend/images/footer-award-two.png')}}" class="img-fluid lazyload" alt="award-two">
                            </div>
                        </div>
