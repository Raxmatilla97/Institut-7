      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item mr-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-modern-menu-template/index.html"><img class="brand-logo" alt="stack admin logo" src="{{ asset('admin/app-assets/images/logo/stack-logo-light.png')}}">
          ...
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                  <div class="avatar avatar-online"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></div><span class="user-name">John Doe</span></a>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="active"><a href="app-contacts.html"><i class="feather icon-users"></i><span class="menu-title" data-i18n="Contacts">Contacts</span></a>
          </li>
...
<section class="row all-contacts">
						...
						<table id="users-contacts" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle">
												<img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-11.png')}}" alt="avatar"><i></i></span></div>
									...
									<td class="text-center">
										<div class="favorite"><i class="feather icon-star"></i></div>
									</td>
									<td>
										<a data-toggle="modal" data-target="#EditContactModal" class="primary edit mr-1"><i class="fa fa-pencil"></i></a>
										<a class="danger delete mr-1"><i class="fa fa-trash-o"></i></a>
										<span class="dropdown">
											<a id="btnSearchDrop3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" class="dropdown-toggle dropdown-menu-right secondary">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-14.png')}}"
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-3.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-5.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-8.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-off rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-7.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-9.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-10.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-18.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-off rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-17.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-2.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-1.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-4.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-13.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-6.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-16.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
								...
								<tr>
									...
									<td>
										<div class="media">
											<div class="media-left pr-1"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-22.png')}}"
													 alt="avatar"><i></i></span></div>
											<div class="media-body media-middle">
    ...
    <div class="card">
        <div class="card-head">
            <div class="media p-1">
                <div class="media-left pr-1"><span class="avatar avatar-online avatar-sm rounded-circle"><img src="{{ asset('admin/app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span></div>
                <div class="media-body media-middle">
